...
function draw() {
  ...
  if(path.x < 0 ){
    ...
    //código para tocar o som de campainha de bicicleta
  if(keyDown("space")) {
    cycleBell.play();
  }
  
  //criando jogadores adversários continuamente
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    textSize(20);
    fill(255);
    text("Pressione a Seta Para Cima para Reiniciar o Jogo!", 500,200);
